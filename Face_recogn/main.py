...
def get_images(path):
    ...
    for image_path in image_paths:
        ...
        known_face_names.append(subject_number)
...
known_face_encodings, known_face_names = get_images(path)

cv2.namedWindow("main", cv2.WINDOW_NORMAL)
cv2.resizeWindow('main', 500, 700)

# Get a reference to webcam #0 (the default one)
video_capture = cv2.VideoCapture('http://192.168.0.10:8080/video')
